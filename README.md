...
| **装上本工具**    | 笔尖轻点 = 鼠标左键；**快速划动 = 翻页滚动**（不误选文字）；**停住再划 = 拖拽**（拖窗口、划选文字）；**停住不动 = 右键菜单**；**笔侧键 / 橡皮擦端 = 自选动作** |
...
* **🎛 按键绑定** — 笔侧键和橡皮擦端可以各绑一个动作：右键菜单、中键单击、左键单击、双击、空格键、返回，或者关掉。绑成左键/中键时**按住侧键再动笔就是拖拽**，松开才结束 —— 不用等长按，随手就能拖窗口、拖文件、划选文字。
...
| 按键绑定  | **笔侧键 / 橡皮擦端 各绑一个动作**（右键菜单 / 中键单击 / 左键单击 / 双击 / 空格键 / 返回 / 关），并实时显示最近按下的那个键                                                         |
